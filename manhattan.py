...
def manhattan(user_experience,user_skills):
    ...
    # Calculate the Manhattan distance between the user's skills and the job skills
    manhattan_dist = pairwise_distances(skills_dense, user_skills_dense, metric='manhattan')

    # Add the similarity score to the DataFrame
    filtered_jobs_df = filtered_jobs_df.assign(similarity=(1 - manhattan_dist.flatten()))
